...
//     <View style={{ backgroundColor: '#131315', paddingBottom: moderateScaleVertical(10) }}>
//       <View style={{}}>
//         <Search />
//       </View>
...
//         <ScrollView stickyHeaderIndices={[1]} contentContainerStyle={{ paddingBottom: moderateScaleVertical(20) }}>
//           {renderHeader()}
//           {renderStickySection()}
